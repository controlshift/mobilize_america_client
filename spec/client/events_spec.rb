...
RSpec.describe MobilizeAmericaClient::Client::Events do
  ...
  describe '#organization_events' do
    ...
    it 'should call the endpoint and return JSON' do
      stub_request(:get, events_url).with(headers: standard_headers).to_return(body: response.to_json, headers: standard_headers)
    ...
    it 'should escape the organization ID' do
      ...
      stub_request(:get, expected_url).with(headers: standard_headers).to_return(body: response.to_json, headers: standard_headers)
    ...
    it 'should support a timeslot_start parameter' do
      ...
      stub_request(:get, events_url)
        ...
        .to_return(body: response.to_json, headers: standard_headers)
